...
var wtf = require('../../tools/writeFile');
var path = require('path');
var fs = require('fs');
var md5 = require('../../tools/md5.js');

module.exports = function(from, to, cssList) {
	...
	var ret = {}, mapping = md5.getMD5Mapping();
	for(var k in list) {
		ret[k] = cmb(k, list, mapping);
	...
	for(var k in ret) {
		wtf(ret[k], path.resolve(k).replace(from, to),k);
