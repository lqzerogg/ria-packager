...
module.exports = function(req, res,config) {
    ...
    if (!fs.existsSync(file) || !fs.statSync(file).isFile()) {
        ...
        if(req.query.template_data && fs.existsSync(path.join(testDir,req.query.template_data))){
            try {
                data = JSON.parse(removeBOMChar(fs.readFileSync(path.join(testDir,req.query.template_data),'utf-8')));
            } catch (e) {
                console.error(e);
            ...
            try {
                data = JSON.parse(removeBOMChar(fs.readFileSync(dataFile,'utf-8')));
            } catch (e) {
                console.error(e);
