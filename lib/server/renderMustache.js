...
module.exports = function(req, res,config) {
    ...
    if (!fs.existsSync(file) || !fs.statSync(file).isFile()) {
        ...
        data.main_css = prefix + '/'+ project +  templateName.replace('.html', '.css');
        data.main_js = prefix + '/'+ project + templateName.replace('.html', '.js');
        data.theme_css = prefix + req.query.theme || ('/' + project + '/less/theme/default.css');
        if(req.query.i18n){
            data.language_js = prefix + '/' + project + '/js/i18n/' + req.query.i18n + '.js';
            data.language_css = prefix + '/' + project + '/less/i18n/' + req.query.i18n + '.less';
        }else{
            data.language_js = prefix + '/' + project + '/js/i18n/en.js';
            data.language_css = prefix + '/' + project + '/less/i18n/en.less';
        }
