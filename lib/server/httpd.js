...
var debugRoute = require('./debug/router.js');

var docRoute = require('../doc/router.js');
...
var app = express();
// app.use(app.router);
debugRoute(app, config);
// doc route
docRoute(app, config);

/*添加随机图片生成器*/
var imgGenerte = require("./debug/imgGenerator.js").generate;
app.get('/util/pic/:size', imgGenerte);
...
app.use(function(req, res, next) {
    ...
    if (ext === '.html') {
        ...
        var data = renderMustache.generateJSON(cfg);
        return renderMustache.generateHTML(cfg, res, data)
    }
